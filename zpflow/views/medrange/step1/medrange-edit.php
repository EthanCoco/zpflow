...
<div class="layui-side_sendmsg">
    ...
    <div id="flow5_step1_medrange_edit_datagrid">
...
<?php $this->endBody() ?>
<script>
var __flow5_step1_medrange_edit_recID__ = "<?= $recID; ?>";
var __flow5_step1_medrange_edit_editIndex__ = "";
$(function(){
	$('#flow5_step1_medrange_edit_datagrid').datagrid({    
	    url:'./json/stepIndex_five_step1.json',
	    rownumbers: true, 
	    columns:[[    
	...
	layui.use(['form','layedit'], function(){
		...
		__flow5_step1_medrange_edit_editIndex__ = layedit.build('ntsContent', {
...
function flow5_step1_medrange_edit_save(){
	layui.use(['form','layedit'], function(){
	 	var form = layui.form,
	 	layedit = layui.layedit;
	 	var ntsTitle = $("#ntsTitle").val().trim();
	 	var ntsID = $("#ntsID").val();
	 	var ntsContent = layedit.getContent(__flow5_step1_medrange_edit_editIndex__);
	 	if(ntsTitle == ""){

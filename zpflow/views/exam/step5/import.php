...
<div style="padding: 10px;">
	<table class="layui-table" lay-skin="nob" lay-size="lg">
	 ...
	 <tbody>
	    ...
	    <tr>
	      	<td>模板下载</td>
	      	<td><a href="javascript:void(0)" style="text-decoration:underline;color:blue;" onclick='window.open("<?= Url::to(['examinee/exam-result-importmb']) ?>"+"&recID=<?= $recID ?>");'>考生成绩导入模板.xls</a></td>
	    </tr>
	</tbody>
</table>
...
<?php $this->endBody() ?>
<script>
var __step5_import_recID__ = "<?= $recID ?>";	
$(function(){
	$("#fileName").val("");
	$("#showhtml").html("");
